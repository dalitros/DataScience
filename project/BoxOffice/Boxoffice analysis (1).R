...
boxplot(movie_ff$original_language)
hist(table(movie_ff$original_language))
t <- table(movie_ff$original_language)
class(t)
summary(t)
t
barplot(sort(table(movie_ff$original_language), decreasing = TRUE))


####################### Analyze popularity_group:
summary(movie_ff$popularity_group)
table(movie_ff$popularity_group)
sum(is.na(movie_ff$popularity_group))
sd(movie_ff$popularity_group)
nrow(table(movie_ff$popularity_group))
max(table(movie_ff$popularity_group))
calculate_mode(movie_ff$popularity_group)
hist(movie_ff$popularity_group, breaks=200)
barplot(sort(table(movie_ff$popularity_group), decreasing = TRUE))
...
hist(movie_ff$runtime2, breaks = 400, na.rm = TRUE)
...
sd(movie_ff$keyword_cnt)
hist(movie_ff$keyword_cnt, breaks=200)
...
hist(movie_ff$keyword_cnt2, breaks = 400, na.rm = TRUE)
...
sd(movie_ff$actors_cnt)
hist(movie_ff$actors_cnt, breaks=200)
boxplot(movie_ff$actors_cnt)

####################### Analyze producers_cnt:
summary(movie_ff$producers_cnt)
table(movie_ff$producers_cnt)
...
sd(movie_ff$producers_cnt)
hist(movie_ff$producers_cnt, breaks=200)
boxplot(movie_ff$producers_cnt)

####################### Analyze actor0_movies_5y_cnt:
summary(movie_ff$actor0_movies_5y_cnt)
table(movie_ff$actor0_movies_5y_cnt)
...
sd(movie_ff$actor0_movies_5y_cnt)
hist(movie_ff$actor0_movies_5y_cnt, breaks=200)
boxplot(movie_ff$actor0_movies_5y_cnt)

####################### Analyze actor2_movies_cnt:
summary(movie_ff$actor2_movies_cnt)
table(movie_ff$actor2_movies_cnt)
...
sd(movie_ff$actor2_movies_cnt)
hist(movie_ff$actor2_movies_cnt, breaks=200)
...
table(movie_ff$actor1_prev_revenue)
...
sd(movie_ff$actor1_prev_revenue)
hist(movie_ff$actor1_prev_revenue, breaks=400)
boxplot(movie_ff$actor1_prev_revenue)

####################### Analyze director_movies_5y_cnt:
summary(movie_ff$director_movies_5y_cnt)
table(movie_ff$director_movies_5y_cnt)
...
sd(movie_ff$director_movies_5y_cnt)
hist(movie_ff$director_movies_5y_cnt, breaks=200)
...
sd(movie_ff$depart_Camera)
hist(movie_ff$depart_Camera, breaks=200)
boxplot(movie_ff$depart_Camera)

####################### Analyze depart_Directing:
summary(movie_ff$depart_Directing)
table(movie_ff$depart_Directing)
...
sd(movie_ff$depart_Directing)
hist(movie_ff$depart_Directing, breaks=200)
boxplot(movie_ff$depart_Directing)

####################### Analyze depart_Production:
summary(movie_ff$depart_Production)
table(movie_ff$depart_Production)
...
sd(movie_ff$depart_Production)
hist(movie_ff$depart_Production, breaks=200)
boxplot(movie_ff$depart_Production)

####################### Analyze depart_Writing:
summary(movie_ff$depart_Writing)
table(movie_ff$depart_Writing)
...
sd(movie_ff$depart_Writing)
hist(movie_ff$depart_Writing, breaks=200)
boxplot(movie_ff$depart_Writing)

####################### Analyze depart_Crew_female:
summary(movie_ff$depart_Crew_female)
table(movie_ff$depart_Crew_female)
...
sd(movie_ff$depart_Crew_female)
hist(movie_ff$depart_Crew_female, breaks=200)
boxplot(movie_ff$depart_Crew_female)

####################### Analyze depart_Editing_female:
summary(movie_ff$depart_Editing_female)
table(movie_ff$depart_Editing_female)
...
sd(movie_ff$depart_Editing_female)
hist(movie_ff$depart_Editing_female, breaks=200)
boxplot(movie_ff$depart_Editing_female)

####################### Analyze depart_Sound_female:
summary(movie_ff$depart_Sound_female)
table(movie_ff$depart_Sound_female)
...
sd(movie_ff$depart_Sound_female)
hist(movie_ff$depart_Sound_female, breaks=200)
