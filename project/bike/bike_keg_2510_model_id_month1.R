...
write.csv(dff,file="C:/Users/dalit/DataScience/project/bike/train_test_svm_311020.csv",row.names = FALSE)
...
df_test1$cnt
pred9_final1 <- predict(mod9, newdata=df_test1)

ids<-df_test$id

dff1<-data.frame(id=ids, cnt=pred9_final1)
write.csv(dff1,file="C:/Users/dalit/DataScience/project/bike/results_svm1_311020.csv",row.names = FALSE)
...
pred9_final <- predict(mod9, newdata=df_test)

dff<-data.frame(id=ids, cnt=pred9_final)
write.csv(dff,file="C:/Users/dalit/DataScience/project/bike/results_svm_311020.csv",row.names = FALSE)
