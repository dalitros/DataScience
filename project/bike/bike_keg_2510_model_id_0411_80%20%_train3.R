...
df_test <- read.csv("C:/Users/dalit/DataScience/project/bike/test0411.csv")
...
write.csv(dff,file="C:/Users/dalit/DataScience/project/bike/results_80_svm_041120_miss.csv",row.names = FALSE)
...
write.csv(dff,file="C:/Users/dalit/DataScience/project/bike/results_80_xgboost_0411020_miss.csv",row.names = FALSE)
