...
write.csv(dff,file="C:/Users/dalit/DataScience/project/bike/results_80_svm_041120.csv",row.names = FALSE)
...
write.csv(dff,file="C:/Users/dalit/DataScience/project/bike/results_80_xgboost_0411020.csv",row.names = FALSE)
