...
##################################################################################################
df_train <- read.csv("C:/Users/dalit/DataScience/project/bike/train5.csv")
...
df_train$mnth_cat <- factor(df_train$mnth_cat)
...
df_test$windspeed_cat  <- ifelse(df_test$windspeed <= 0.2,0,1)
df_test$hum_cat  <- ifelse(df_test$hum <= 0.8,0,1)
df_test$temp_cat  <- ifelse(df_test$temp < 0.5,1,0)
df_test$mnth_cat = df_test$mnth
df_test$mnth_cat[df_test$mnth == 1|df_test$mnth == 2|df_test$mnth == 3|df_test$mnth == 4] <- "1"
df_test$mnth_cat[df_test$mnth == 5|df_test$mnth == 6|df_test$mnth == 7|df_test$mnth == 8|df_test$mnth == 9] <- "2"                 
df_test$mnth_cat[df_test$mnth == 10|df_test$mnth == 11|df_test$mnth == 12] <- "3"
...
df_test$hum_cat <- factor(df_test$hum_cat)
df_test$windspeed_cat <- factor(df_test$windspeed_cat)
df_test$temp_cat <- factor(df_test$temp_cat)
df_test$mnth_cat <- factor(df_test$mnth_cat)
...
write.csv(dff,file="C:/Users/dalit/DataScience/project/bike/results_80_lm_051120_new_var.csv",row.names = FALSE)
